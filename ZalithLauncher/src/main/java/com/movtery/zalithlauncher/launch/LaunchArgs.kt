...
class LaunchArgs(
    ...
    fun getAllArgs(): List<String> {
        ...
        argsList.addAll(getMinecraftJVMArgs(lwjglComponent))
        argsList.add("-cp")
    ...
    private fun getJavaArgs(lwjglComponent: String): List<String> {
        ...
        argsList.add("-Djava.library.path=${buildLibraryPath(lwjglComponent)}")
    ...
    private fun buildLibraryPath(lwjglComponent: String): String {
